...
const Second = () => {
  ...
  const divscroll_left = useTransform(scrollYProgress2, [0, 1], ['300%', '0%']);
  const divscroll_right = useTransform(scrollYProgress2, [0, 1], ['-300%', '230%']);

  return (
    <div className="second_wrapper flex justify-center overflow-hidden relative screen_width">
